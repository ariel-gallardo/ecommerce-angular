...
import { selectDeleteHasError } from './error.selector';
import { selectDeleteErrors } from './error.selector';
import { selectDeleteLoaded } from './error.selector';
import { selectFiltersFirstGetRequest } from './error.selector';
import { selectFiltersFirstGetData } from './error.selector';
import { selectFiltersFirstGetHasError } from './error.selector';
import { selectFiltersFirstGetErrors } from './error.selector';
import { selectFiltersFirstGetLoaded } from './error.selector';
import { selectFiltersGetRequest } from './error.selector';
import { selectFiltersGetData } from './error.selector';
import { selectFiltersGetHasError } from './error.selector';
import { selectFiltersGetErrors } from './error.selector';
import { selectFiltersGetLoaded } from './error.selector';
import { selectGetRequest } from './error.selector';
import { selectGetData } from './error.selector';
import { selectGetHasError } from './error.selector';
import { selectGetErrors } from './error.selector';
import { selectGetLoaded } from './error.selector';
import { selectIdsGetRequest } from './error.selector';
import { selectIdsGetData } from './error.selector';
import { selectIdsGetHasError } from './error.selector';
import { selectIdsGetErrors } from './error.selector';
import { selectIdsGetLoaded } from './error.selector';
import { selectPostRequest } from './error.selector';
import { selectPostData } from './error.selector';
import { selectPostHasError } from './error.selector';
import { selectPostErrors } from './error.selector';
import { selectPostLoaded } from './error.selector';
import { selectPutRequest } from './error.selector';
import { selectPutData } from './error.selector';
import { selectPutHasError } from './error.selector';
import { selectPutErrors } from './error.selector';
import { selectPutLoaded } from './error.selector';
import { selectRangeDeleteRequest } from './error.selector';

import { selectRangeDeleteHasError } from './error.selector';
import { selectRangeDeleteErrors } from './error.selector';
import { selectRangeDeleteLoaded } from './error.selector';
import { selectRangePostRequest } from './error.selector';
import { selectRangePostData } from './error.selector';
import { selectRangePostHasError } from './error.selector';
import { selectRangePostErrors } from './error.selector';
import { selectRangePostLoaded } from './error.selector';
import { selectRangePutRequest } from './error.selector';
import { selectRangePutData } from './error.selector';
import { selectRangePutHasError } from './error.selector';
import { selectRangePutErrors } from './error.selector';
import { selectRangePutLoaded } from './error.selector';
...
export class ErrorFacade {
  ...
  public get FiltersFirstGet$(): Observable<LogError> { return this.store.select(selectFiltersFirstGetData).pipe(filter(x => x !== null)); }
  ...
  public get FiltersGet$(): Observable<Pagination<LogError>> { return this.store.select(selectFiltersGetData).pipe(filter(x => x !== null)); }
  ...
  public get Get$(): Observable<LogError> { return this.store.select(selectGetData).pipe(filter(x => x !== null)); }
  ...
  public get IdsGet$(): Observable<Pagination<LogError>> { return this.store.select(selectIdsGetData).pipe(filter(x => x !== null)); }
  ...
  public get Post$(): Observable<LogError> { return this.store.select(selectPostData).pipe(filter(x => x !== null)); }
  ...
  public get Put$(): Observable<LogError> { return this.store.select(selectPutData).pipe(filter(x => x !== null)); }
  ...
  public get RangePost$(): Observable<Pagination<LogError>> { return this.store.select(selectRangePostData).pipe(filter(x => x !== null)); }
  ...
  public get RangePut$(): Observable<Pagination<LogError>> { return this.store.select(selectRangePutData).pipe(filter(x => x !== null)); }
