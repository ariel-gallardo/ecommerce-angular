...
export class LogErrorActions {
  ...
  static DeleteExecute = createAction('[LogError] Delete Execute');
  ...
  static DeleteSuccess = createAction('[LogError] Delete Success');
  static DeleteSetError = createAction('[LogError] Delete SetError', props<{errors: ValidationError[][]}>());
  ...
  static FiltersFirstGetExecute = createAction('[LogError] FiltersFirstGet Execute');
  ...
  static FiltersFirstGetSuccess = createAction('[LogError] FiltersFirstGet Success');
  static FiltersFirstGetSetError = createAction('[LogError] FiltersFirstGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static FiltersGetExecute = createAction('[LogError] FiltersGet Execute');
  ...
  static FiltersGetSuccess = createAction('[LogError] FiltersGet Success');
  static FiltersGetSetError = createAction('[LogError] FiltersGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static GetExecute = createAction('[LogError] Get Execute');
  ...
  static GetSuccess = createAction('[LogError] Get Success');
  static GetSetError = createAction('[LogError] Get SetError', props<{errors: ValidationError[][]}>());

  static IdsGetInit = createAction('[LogError] IdsGetInit');
  static IdsGetDataInit = createAction('[LogError] IdsGetDataInit');
  static IdsGetExecute = createAction('[LogError] IdsGet Execute');
  ...
  static IdsGetSuccess = createAction('[LogError] IdsGet Success');
  static IdsGetSetError = createAction('[LogError] IdsGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static PostExecute = createAction('[LogError] Post Execute');
  ...
  static PostSuccess = createAction('[LogError] Post Success');
  static PostSetError = createAction('[LogError] Post SetError', props<{errors: ValidationError[][]}>());

  static PutInit = createAction('[LogError] PutInit');
  static PutDataInit = createAction('[LogError] PutDataInit');
  static PutExecute = createAction('[LogError] Put Execute');
  ...
  static PutSuccess = createAction('[LogError] Put Success');
  static PutSetError = createAction('[LogError] Put SetError', props<{errors: ValidationError[][]}>());
  ...
  static RangeDeleteExecute = createAction('[LogError] RangeDelete Execute');
  ...
  static RangeDeleteSuccess = createAction('[LogError] RangeDelete Success');
  static RangeDeleteSetError = createAction('[LogError] RangeDelete SetError', props<{errors: ValidationError[][]}>());

  static RangePostInit = createAction('[LogError] RangePostInit');
  static RangePostDataInit = createAction('[LogError] RangePostDataInit');
  static RangePostExecute = createAction('[LogError] RangePost Execute');
  ...
  static RangePostSuccess = createAction('[LogError] RangePost Success');
  static RangePostSetError = createAction('[LogError] RangePost SetError', props<{errors: ValidationError[][]}>());
  ...
  static RangePutExecute = createAction('[LogError] RangePut Execute');
  ...
  static RangePutSuccess = createAction('[LogError] RangePut Success');
  static RangePutSetError = createAction('[LogError] RangePut SetError', props<{errors: ValidationError[][]}>());
