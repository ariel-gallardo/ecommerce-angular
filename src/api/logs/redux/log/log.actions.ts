...
export class LogActions {
  ...
  static DeleteExecute = createAction('[Log] Delete Execute');
  ...
  static DeleteSuccess = createAction('[Log] Delete Success');
  static DeleteSetError = createAction('[Log] Delete SetError', props<{errors: ValidationError[][]}>());
  ...
  static FiltersFirstGetExecute = createAction('[Log] FiltersFirstGet Execute');
  ...
  static FiltersFirstGetSuccess = createAction('[Log] FiltersFirstGet Success');
  static FiltersFirstGetSetError = createAction('[Log] FiltersFirstGet SetError', props<{errors: ValidationError[][]}>());

  static FiltersGetInit = createAction('[Log] FiltersGetInit');
  static FiltersGetDataInit = createAction('[Log] FiltersGetDataInit');
  static FiltersGetExecute = createAction('[Log] FiltersGet Execute');
  ...
  static FiltersGetSuccess = createAction('[Log] FiltersGet Success');
  static FiltersGetSetError = createAction('[Log] FiltersGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static GetExecute = createAction('[Log] Get Execute');
  ...
  static GetSuccess = createAction('[Log] Get Success');
  static GetSetError = createAction('[Log] Get SetError', props<{errors: ValidationError[][]}>());

  static IdsGetInit = createAction('[Log] IdsGetInit');
  static IdsGetDataInit = createAction('[Log] IdsGetDataInit');
  static IdsGetExecute = createAction('[Log] IdsGet Execute');
  ...
  static IdsGetSuccess = createAction('[Log] IdsGet Success');
  static IdsGetSetError = createAction('[Log] IdsGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static PostExecute = createAction('[Log] Post Execute');
  ...
  static PostSuccess = createAction('[Log] Post Success');
  static PostSetError = createAction('[Log] Post SetError', props<{errors: ValidationError[][]}>());

  static PutInit = createAction('[Log] PutInit');
  static PutDataInit = createAction('[Log] PutDataInit');
  static PutExecute = createAction('[Log] Put Execute');
  ...
  static PutSuccess = createAction('[Log] Put Success');
  static PutSetError = createAction('[Log] Put SetError', props<{errors: ValidationError[][]}>());

  static RangeDeleteInit = createAction('[Log] RangeDeleteInit');
  static RangeDeleteDataInit = createAction('[Log] RangeDeleteDataInit');
  static RangeDeleteExecute = createAction('[Log] RangeDelete Execute');
  ...
  static RangeDeleteSuccess = createAction('[Log] RangeDelete Success');
  static RangeDeleteSetError = createAction('[Log] RangeDelete SetError', props<{errors: ValidationError[][]}>());

  static RangePostInit = createAction('[Log] RangePostInit');
  static RangePostDataInit = createAction('[Log] RangePostDataInit');
  static RangePostExecute = createAction('[Log] RangePost Execute');
  ...
  static RangePostSuccess = createAction('[Log] RangePost Success');
  static RangePostSetError = createAction('[Log] RangePost SetError', props<{errors: ValidationError[][]}>());
  ...
  static RangePutExecute = createAction('[Log] RangePut Execute');
  ...
  static RangePutSuccess = createAction('[Log] RangePut Success');
  static RangePutSetError = createAction('[Log] RangePut SetError', props<{errors: ValidationError[][]}>());
