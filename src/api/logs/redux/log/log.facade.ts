...
export class LogFacade {
  ...
  public get FiltersFirstGet$(): Observable<Log> { return this.store.select(selectFiltersFirstGetData); }
  ...
  public get FiltersGet$(): Observable<Pagination<Log>> { return this.store.select(selectFiltersGetData); }
  ...
  public get Get$(): Observable<Log> { return this.store.select(selectGetData); }
  ...
  public get IdsGet$(): Observable<Pagination<Log>> { return this.store.select(selectIdsGetData); }
  ...
  public get Post$(): Observable<Log> { return this.store.select(selectPostData); }
  ...
  public get Put$(): Observable<Log> { return this.store.select(selectPutData); }
  ...
  public get RangePost$(): Observable<Pagination<Log>> { return this.store.select(selectRangePostData); }
  ...
  public get RangePut$(): Observable<Pagination<Log>> { return this.store.select(selectRangePutData); }
