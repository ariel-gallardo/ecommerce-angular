...
export class CategoryFacade {
  ...
  public get FiltersFirstGet$(): Observable<Category> { return this.store.select(selectFiltersFirstGetData); }
  ...
  public get FiltersGet$(): Observable<Pagination<Category>> { return this.store.select(selectFiltersGetData); }
  ...
  public get Get$(): Observable<Category> { return this.store.select(selectGetData); }
  ...
  public get IdsGet$(): Observable<Pagination<Category>> { return this.store.select(selectIdsGetData); }
  ...
  public get Post$(): Observable<Category> { return this.store.select(selectPostData); }
  ...
  public get Put$(): Observable<Category> { return this.store.select(selectPutData); }
  ...
  public get RangePost$(): Observable<Pagination<Category>> { return this.store.select(selectRangePostData); }
  ...
  public get RangePut$(): Observable<Pagination<Category>> { return this.store.select(selectRangePutData); }
