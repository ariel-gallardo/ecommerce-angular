...
export class ProductFacade {
  ...
  public get FiltersFirstGet$(): Observable<Product> { return this.store.select(selectFiltersFirstGetData).pipe(filter(x => x !== null)); }
  ...
  public get FiltersGet$(): Observable<Pagination<Product>> { return this.store.select(selectFiltersGetData).pipe(filter(x => x !== null)); }
  ...
  public get Get$(): Observable<Product> { return this.store.select(selectGetData).pipe(filter(x => x !== null)); }
  ...
  public get IdsGet$(): Observable<Pagination<Product>> { return this.store.select(selectIdsGetData).pipe(filter(x => x !== null)); }
  ...
  public get Post$(): Observable<Product> { return this.store.select(selectPostData).pipe(filter(x => x !== null)); }
  ...
  public get Put$(): Observable<Product> { return this.store.select(selectPutData).pipe(filter(x => x !== null)); }
  ...
  public get RangePost$(): Observable<Pagination<Product>> { return this.store.select(selectRangePostData).pipe(filter(x => x !== null)); }
  ...
  public get RangePut$(): Observable<Pagination<Product>> { return this.store.select(selectRangePutData).pipe(filter(x => x !== null)); }
