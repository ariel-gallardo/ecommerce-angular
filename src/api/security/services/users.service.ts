...
import { UsersReduxModule } from '@api/security/redux/users/users.module';
// @ts-ignore
...
export class PostRequest {
    userRegister?: UserRegister | undefined | null;
...
export class RegisterPostRequest {
    userRegister?: UserRegister | undefined | null;
    constructor(init: Partial<RegisterPostRequest> = {}){
            
             this.userRegister = new UserRegister(); 
        const keys = (Object.keys(init) as (keyof RegisterPostRequest)[])
        .filter(k => this[k] !== init[k]);
        if(keys.length > 0){
            keys.forEach(k => {
                //@ts-ignore
...
export class UsersService extends BaseService {
    ...
    public Delete(requestParameters?: DeleteRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        let localVarPath = `/security/Users`;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public FiltersFirstGet(requestParameters?: FiltersFirstGetRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<User>>;
    ...
    public FiltersFirstGet(requestParameters?: FiltersFirstGetRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        let localVarPath = `/security/Users/filters-first`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public FiltersGet(requestParameters?: FiltersGetRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<Pagination<User>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public Get(requestParameters?: GetRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<User>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public IdsGet(requestParameters?: IdsGetRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<Pagination<User>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public LoginPost(requestParameters: LoginPostRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain' | 'text/json',}): Observable<Response<string>>;
    ...
    public LoginPost(requestParameters: LoginPostRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/plain' | 'text/json',}): Observable<any> {
        ...
        let localVarPath = `/security/Users/login`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public Post(requestParameters: PostRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<User>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public Put(requestParameters: PutRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<User>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public RangePost(requestParameters: RangePostRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<Pagination<User>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public RangePut(requestParameters: RangePutRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<Pagination<User>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public RegisterPost(requestParameters: RegisterPostRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json',}): Observable<Response<User>>;
    ...
    public RegisterPost(requestParameters: RegisterPostRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json',}): Observable<any> {
        ...
        let localVarPath = `/security/Users/register`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<User>('POST', `${basePath}${localVarPath}`,
            {
                body: userRegister,
