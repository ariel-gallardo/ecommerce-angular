...
import { selectDeleteHasError } from './personas.selector';
import { selectDeleteErrors } from './personas.selector';
import { selectDeleteLoaded } from './personas.selector';
import { selectFiltersFirstGetRequest } from './personas.selector';
import { selectFiltersFirstGetData } from './personas.selector';
import { selectFiltersFirstGetHasError } from './personas.selector';
import { selectFiltersFirstGetErrors } from './personas.selector';
import { selectFiltersFirstGetLoaded } from './personas.selector';
import { selectFiltersGetRequest } from './personas.selector';
import { selectFiltersGetData } from './personas.selector';
import { selectFiltersGetHasError } from './personas.selector';
import { selectFiltersGetErrors } from './personas.selector';
import { selectFiltersGetLoaded } from './personas.selector';
import { selectGetRequest } from './personas.selector';
import { selectGetData } from './personas.selector';
import { selectGetHasError } from './personas.selector';
import { selectGetErrors } from './personas.selector';
import { selectGetLoaded } from './personas.selector';
import { selectIdsGetRequest } from './personas.selector';
import { selectIdsGetData } from './personas.selector';
import { selectIdsGetHasError } from './personas.selector';
import { selectIdsGetErrors } from './personas.selector';
import { selectIdsGetLoaded } from './personas.selector';
import { selectPostRequest } from './personas.selector';
import { selectPostData } from './personas.selector';
import { selectPostHasError } from './personas.selector';
import { selectPostErrors } from './personas.selector';
import { selectPostLoaded } from './personas.selector';
import { selectPutRequest } from './personas.selector';
import { selectPutData } from './personas.selector';
import { selectPutHasError } from './personas.selector';
import { selectPutErrors } from './personas.selector';
import { selectPutLoaded } from './personas.selector';
import { selectRangeDeleteRequest } from './personas.selector';

import { selectRangeDeleteHasError } from './personas.selector';
import { selectRangeDeleteErrors } from './personas.selector';
import { selectRangeDeleteLoaded } from './personas.selector';
import { selectRangePostRequest } from './personas.selector';
import { selectRangePostData } from './personas.selector';
import { selectRangePostHasError } from './personas.selector';
import { selectRangePostErrors } from './personas.selector';
import { selectRangePostLoaded } from './personas.selector';
import { selectRangePutRequest } from './personas.selector';
import { selectRangePutData } from './personas.selector';
import { selectRangePutHasError } from './personas.selector';
import { selectRangePutErrors } from './personas.selector';
import { selectRangePutLoaded } from './personas.selector';
import { PageEvent } from '@angular/material/paginator';

@Injectable()
export class PersonasFacade {
  constructor(private store: Store<{ Personas: State }>) {}
  ...
  public get FiltersFirstGet$(): Observable<Persona> { return this.store.select(selectFiltersFirstGetData).pipe(filter(x => x !== null)); }
  ...
  public get FiltersGet$(): Observable<Pagination<Persona>> { return this.store.select(selectFiltersGetData).pipe(filter(x => x !== null)); }
  ...
  public get Get$(): Observable<Persona> { return this.store.select(selectGetData).pipe(filter(x => x !== null)); }
  ...
  public get IdsGet$(): Observable<Pagination<Persona>> { return this.store.select(selectIdsGetData).pipe(filter(x => x !== null)); }
  ...
  public get Post$(): Observable<Persona> { return this.store.select(selectPostData).pipe(filter(x => x !== null)); }
  ...
  public get Put$(): Observable<Persona> { return this.store.select(selectPutData).pipe(filter(x => x !== null)); }
  ...
  public get RangePost$(): Observable<Pagination<Persona>> { return this.store.select(selectRangePostData).pipe(filter(x => x !== null)); }
  ...
  public get RangePut$(): Observable<Pagination<Persona>> { return this.store.select(selectRangePutData).pipe(filter(x => x !== null)); }
