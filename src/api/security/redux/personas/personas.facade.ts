...
export class PersonasFacade {
  ...
  public get FiltersFirstGet$(): Observable<Persona> { return this.store.select(selectFiltersFirstGetData); }
  ...
  public get FiltersGet$(): Observable<Pagination<Persona>> { return this.store.select(selectFiltersGetData); }
  ...
  public get Get$(): Observable<Persona> { return this.store.select(selectGetData); }
  ...
  public get IdsGet$(): Observable<Pagination<Persona>> { return this.store.select(selectIdsGetData); }
  ...
  public get Post$(): Observable<Persona> { return this.store.select(selectPostData); }
  ...
  public get Put$(): Observable<Persona> { return this.store.select(selectPutData); }
  ...
  public get RangePost$(): Observable<Pagination<Persona>> { return this.store.select(selectRangePostData); }
  ...
  public get RangePut$(): Observable<Pagination<Persona>> { return this.store.select(selectRangePutData); }
