...
const initialState = {
    ...
    FiltersGet: {
        ...
        isLoaded: null,
        errors: [],
        data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []},
        request: null,
    },
    Get: {
        firstInit: true,
...
const reducer = createReducer<State>(
  initialState,
    ...
    on(Actions.FiltersGetInit, state => ({...state, FiltersGet:{ ...state.FiltersGet, firstInit: false, hasError: null, errors: [], isLoaded: null, data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}   , request: null} })),
    on(Actions.FiltersGetDataInit, state => ({...state, FiltersGet:{ ...state.FiltersGet , data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}  } })),
    ...
    on(Actions.IdsGetInit, state => ({...state, IdsGet:{ ...state.IdsGet, firstInit: false, hasError: null, errors: [], isLoaded: null, data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}   , request: null} })),
    on(Actions.IdsGetDataInit, state => ({...state, IdsGet:{ ...state.IdsGet , data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}  } })),
    ...
    on(Actions.LoginPostInit, state => ({...state, LoginPost:{ ...state.LoginPost, firstInit: false, hasError: null, errors: [], isLoaded: null, data: null   , request: null} })),
    on(Actions.LoginPostDataInit, state => ({...state, LoginPost:{ ...state.LoginPost , data: null  } })),
    on(Actions.LoginPostSetData, (state, {data}) => ({ ...state, LoginPost: {...state.LoginPost, data: data, isLoaded: null, hasError: false, errors: [] }})),
    on(Actions.LoginPostSetError, (state,{errors}) => ({ ...state, LoginPost: {...state.LoginPost, isLoaded: false, hasError: true,errors: errors  }})),
    on(Actions.LoginPostSuccess, (state) => ({ ...state, LoginPost: {...state.LoginPost, isLoaded: true, hasError: false, errors: [] }})),
    on(Actions.LoginPostRequestUpdateOneSuccess, (state, {key, value}) => ({ ...state, LoginPost: {...state.LoginPost, request: {...state.LoginPost.request, [key]: value } }})),
    on(Actions.LoginPostRequestUpdateSuccess, (state, {request}) => ({ ...state, LoginPost: {...state.LoginPost, request: request }})),
    ...
    on(Actions.RangePostInit, state => ({...state, RangePost:{ ...state.RangePost, firstInit: false, hasError: null, errors: [], isLoaded: null, data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}   , request: null} })),
    on(Actions.RangePostDataInit, state => ({...state, RangePost:{ ...state.RangePost , data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}  } })),
    ...
    on(Actions.RangePutInit, state => ({...state, RangePut:{ ...state.RangePut, firstInit: false, hasError: null, errors: [], isLoaded: null, data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}   , request: null} })),
    on(Actions.RangePutDataInit, state => ({...state, RangePut:{ ...state.RangePut , data: {currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: []}  } })),
    ...
    on(Actions.RegisterPostInit, state => ({...state, RegisterPost:{ ...state.RegisterPost, firstInit: false, hasError: null, errors: [], isLoaded: null, data: null   , request: null} })),
    on(Actions.RegisterPostDataInit, state => ({...state, RegisterPost:{ ...state.RegisterPost , data: null  } })),
    ...
    on(Actions.RegisterPostSetError, (state,{errors}) => ({ ...state, RegisterPost: {...state.RegisterPost, isLoaded: false, hasError: true,errors: errors  }})),
    on(Actions.RegisterPostSuccess, (state) => ({ ...state, RegisterPost: {...state.RegisterPost, isLoaded: true, hasError: false, errors: [] }})),
    on(Actions.RegisterPostRequestUpdateOneSuccess, (state, {key, value}) => ({ ...state, RegisterPost: {...state.RegisterPost, request: {...state.RegisterPost.request, [key]: value } }})),
    on(Actions.RegisterPostRequestUpdateSuccess, (state, {request}) => ({ ...state, RegisterPost: {...state.RegisterPost, request: request }})),
);
