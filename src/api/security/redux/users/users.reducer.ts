...
const initialState = {
    ...
    FiltersGet: {
        ...
        isLoaded: null,
        errors: [],
        data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User> ,
        request: null,
    },
    Get: {
        firstInit: true,
...
const reducer = createReducer<State>(
  initialState,
    ...
    // @ts-ignore
    on(Actions.FiltersFirstGetInit, state => ({...state, FiltersFirstGet:{ ...state.FiltersFirstGet, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  {  } as User  , request: null} })),
    // @ts-ignore
    on(Actions.FiltersFirstGetDataInit, state => ({...state, FiltersFirstGet:{ ...state.FiltersFirstGet, data: {  } as User}})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.FiltersFirstGetSetError, (state,{errors}) => ({ ...state, FiltersFirstGet: {...state.FiltersFirstGet, isLoaded: false, hasError: true,errors: errors, data: {  } as User  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.FiltersGetInit, state => ({...state, FiltersGet:{ ...state.FiltersGet, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  , request: null} })),
    // @ts-ignore
    on(Actions.FiltersGetDataInit, state => ({...state, FiltersGet:{ ...state.FiltersGet, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>}})),
    // @ts-ignore
    on(Actions.FiltersGetSetData, (state, {data}) => ({ ...state, FiltersGet: {...state.FiltersGet, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.FiltersGetSetError, (state,{errors}) => ({ ...state, FiltersGet: {...state.FiltersGet, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.GetInit, state => ({...state, Get:{ ...state.Get, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  {  } as User  , request: null} })),
    // @ts-ignore
    on(Actions.GetDataInit, state => ({...state, Get:{ ...state.Get, data: {  } as User}})),
    // @ts-ignore
    on(Actions.GetSetData, (state, {data}) => ({ ...state, Get: {...state.Get, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.GetSetError, (state,{errors}) => ({ ...state, Get: {...state.Get, isLoaded: false, hasError: true,errors: errors, data: {  } as User  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.IdsGetInit, state => ({...state, IdsGet:{ ...state.IdsGet, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  , request: null} })),
    // @ts-ignore
    on(Actions.IdsGetDataInit, state => ({...state, IdsGet:{ ...state.IdsGet, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>}})),
    // @ts-ignore
    on(Actions.IdsGetSetData, (state, {data}) => ({ ...state, IdsGet: {...state.IdsGet, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.IdsGetSetError, (state,{errors}) => ({ ...state, IdsGet: {...state.IdsGet, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.LoginPostInit, state => ({...state, LoginPost:{ ...state.LoginPost, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  {  } as string  , request: null} })),
    // @ts-ignore
    on(Actions.LoginPostDataInit, state => ({...state, LoginPost:{ ...state.LoginPost, data: {  } as string}})),
    // @ts-ignore
    on(Actions.LoginPostSetData, (state, {data}) => ({ ...state, LoginPost: {...state.LoginPost, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.LoginPostSetError, (state,{errors}) => ({ ...state, LoginPost: {...state.LoginPost, isLoaded: false, hasError: true,errors: errors, data: {  } as string  }})),
    // @ts-ignore
    on(Actions.LoginPostSuccess, (state) => ({ ...state, LoginPost: {...state.LoginPost, data: state?.LoginPost?.data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.LoginPostRequestUpdateOneSuccess, (state, {key, value}) => ({ ...state, LoginPost: {...state.LoginPost, ...state.LoginPost ,request: {...state.LoginPost.request, [key]:value} }})),
    // @ts-ignore
    on(Actions.LoginPostRequestUpdateSuccess, (state, {request}) => ({ ...state, LoginPost: {...state.LoginPost, ...state.LoginPost ,request: request }})),
    // @ts-ignore
    on(Actions.PostInit, state => ({...state, Post:{ ...state.Post, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  {  } as User  , request: null} })),
    // @ts-ignore
    on(Actions.PostDataInit, state => ({...state, Post:{ ...state.Post, data: {  } as User}})),
    // @ts-ignore
    on(Actions.PostSetData, (state, {data}) => ({ ...state, Post: {...state.Post, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.PostSetError, (state,{errors}) => ({ ...state, Post: {...state.Post, isLoaded: false, hasError: true,errors: errors, data: {  } as User  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.PutInit, state => ({...state, Put:{ ...state.Put, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  {  } as User  , request: null} })),
    // @ts-ignore
    on(Actions.PutDataInit, state => ({...state, Put:{ ...state.Put, data: {  } as User}})),
    // @ts-ignore
    on(Actions.PutSetData, (state, {data}) => ({ ...state, Put: {...state.Put, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.PutSetError, (state,{errors}) => ({ ...state, Put: {...state.Put, isLoaded: false, hasError: true,errors: errors, data: {  } as User  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.RangePostInit, state => ({...state, RangePost:{ ...state.RangePost, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  , request: null} })),
    // @ts-ignore
    on(Actions.RangePostDataInit, state => ({...state, RangePost:{ ...state.RangePost, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>}})),
    // @ts-ignore
    on(Actions.RangePostSetData, (state, {data}) => ({ ...state, RangePost: {...state.RangePost, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.RangePostSetError, (state,{errors}) => ({ ...state, RangePost: {...state.RangePost, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.RangePutInit, state => ({...state, RangePut:{ ...state.RangePut, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  , request: null} })),
    // @ts-ignore
    on(Actions.RangePutDataInit, state => ({...state, RangePut:{ ...state.RangePut, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>}})),
    // @ts-ignore
    on(Actions.RangePutSetData, (state, {data}) => ({ ...state, RangePut: {...state.RangePut, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.RangePutSetError, (state,{errors}) => ({ ...state, RangePut: {...state.RangePut, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<User>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.RegisterPostInit, state => ({...state, RegisterPost:{ ...state.RegisterPost, firstInit: false, hasError: false, errors: [],  isLoaded: null, data:  {  } as User  , request: null} })),
    // @ts-ignore
    on(Actions.RegisterPostDataInit, state => ({...state, RegisterPost:{ ...state.RegisterPost, data: {  } as User}})),
    // @ts-ignore
    on(Actions.RegisterPostSetData, (state, {data}) => ({ ...state, RegisterPost: {...state.RegisterPost, data: data, isLoaded: null, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.RegisterPostSetError, (state,{errors}) => ({ ...state, RegisterPost: {...state.RegisterPost, isLoaded: false, hasError: true,errors: errors, data: {  } as User  }})),
    // @ts-ignore
    on(Actions.RegisterPostSuccess, (state) => ({ ...state, RegisterPost: {...state.RegisterPost, data: state?.RegisterPost?.data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.RegisterPostRequestUpdateOneSuccess, (state, {key, value}) => ({ ...state, RegisterPost: {...state.RegisterPost, ...state.RegisterPost ,request: {...state.RegisterPost.request, [key]:value} }})),
    // @ts-ignore
    on(Actions.RegisterPostRequestUpdateSuccess, (state, {request}) => ({ ...state, RegisterPost: {...state.RegisterPost, ...state.RegisterPost ,request: request }})),
);
