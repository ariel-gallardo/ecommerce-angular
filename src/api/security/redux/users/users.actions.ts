...
export class UsersActions {
  ...
  static DeleteExecute = createAction('[Users] Delete Execute');
  ...
  static DeleteSuccess = createAction('[Users] Delete Success');
  static DeleteSetError = createAction('[Users] Delete SetError', props<{errors: ValidationError[][]}>());
  ...
  static FiltersFirstGetExecute = createAction('[Users] FiltersFirstGet Execute');
  ...
  static FiltersFirstGetSuccess = createAction('[Users] FiltersFirstGet Success');
  static FiltersFirstGetSetError = createAction('[Users] FiltersFirstGet SetError', props<{errors: ValidationError[][]}>());

  static FiltersGetInit = createAction('[Users] FiltersGetInit');
  static FiltersGetDataInit = createAction('[Users] FiltersGetDataInit');
  static FiltersGetExecute = createAction('[Users] FiltersGet Execute');
  ...
  static FiltersGetSuccess = createAction('[Users] FiltersGet Success');
  static FiltersGetSetError = createAction('[Users] FiltersGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static GetExecute = createAction('[Users] Get Execute');
  ...
  static GetSuccess = createAction('[Users] Get Success');
  static GetSetError = createAction('[Users] Get SetError', props<{errors: ValidationError[][]}>());

  static IdsGetInit = createAction('[Users] IdsGetInit');
  static IdsGetDataInit = createAction('[Users] IdsGetDataInit');
  static IdsGetExecute = createAction('[Users] IdsGet Execute');
  ...
  static IdsGetSuccess = createAction('[Users] IdsGet Success');
  static IdsGetSetError = createAction('[Users] IdsGet SetError', props<{errors: ValidationError[][]}>());
  ...
  static LoginPostExecute = createAction('[Users] LoginPost Execute');
  ...
  static LoginPostSuccess = createAction('[Users] LoginPost Success');
  static LoginPostSetError = createAction('[Users] LoginPost SetError', props<{errors: ValidationError[][]}>());

  static PostInit = createAction('[Users] PostInit');
  static PostDataInit = createAction('[Users] PostDataInit');
  static PostExecute = createAction('[Users] Post Execute');
  ...
  static PostSuccess = createAction('[Users] Post Success');
  static PostSetError = createAction('[Users] Post SetError', props<{errors: ValidationError[][]}>());

  static PutInit = createAction('[Users] PutInit');
  static PutDataInit = createAction('[Users] PutDataInit');
  static PutExecute = createAction('[Users] Put Execute');
  ...
  static PutSuccess = createAction('[Users] Put Success');
  static PutSetError = createAction('[Users] Put SetError', props<{errors: ValidationError[][]}>());
  ...
  static RangeDeleteExecute = createAction('[Users] RangeDelete Execute');
  ...
  static RangeDeleteSuccess = createAction('[Users] RangeDelete Success');
  static RangeDeleteSetError = createAction('[Users] RangeDelete SetError', props<{errors: ValidationError[][]}>());

  static RangePostInit = createAction('[Users] RangePostInit');
  static RangePostDataInit = createAction('[Users] RangePostDataInit');
  static RangePostExecute = createAction('[Users] RangePost Execute');
  ...
  static RangePostSuccess = createAction('[Users] RangePost Success');
  static RangePostSetError = createAction('[Users] RangePost SetError', props<{errors: ValidationError[][]}>());
  ...
  static RangePutExecute = createAction('[Users] RangePut Execute');
  ...
  static RangePutSuccess = createAction('[Users] RangePut Success');
  static RangePutSetError = createAction('[Users] RangePut SetError', props<{errors: ValidationError[][]}>());
  ...
  static RegisterPostExecute = createAction('[Users] RegisterPost Execute');
  ...
  static RegisterPostSuccess = createAction('[Users] RegisterPost Success');
  static RegisterPostSetError = createAction('[Users] RegisterPost SetError', props<{errors: ValidationError[][]}>());
}
