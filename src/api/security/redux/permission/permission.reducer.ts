...
const reducer = createReducer<State>(
  initialState,
    on(Actions.CanAccessHeadInit, state => ({...state, CanAccessHead:{ ...state.CanAccessHead, firstInit: false, hasError: null, errors: [], isLoaded: null, data: null   , request: null} })),
    on(Actions.CanAccessHeadDataInit, state => ({...state, CanAccessHead:{ ...state.CanAccessHead , data: null  } })),
    on(Actions.CanAccessHeadSetData, (state, {data}) => ({ ...state, CanAccessHead: {...state.CanAccessHead, data: data, isLoaded: null, hasError: false, errors: [] }})),
