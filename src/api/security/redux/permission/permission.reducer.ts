...
const reducer = createReducer<State>(
  initialState,
    ...
    on(Actions.CanAccessHeadInit, state => ({...state, CanAccessHead:{ ...state.CanAccessHead, firstInit: false, hasError: false, errors: [],  isLoaded: null, data: new HttpHeaders() , request: null} })),
    
    on(Actions.CanAccessHeadDataInit, state => ({...state, CanAccessHead:{ ...state.CanAccessHead, data: {  } as HttpHeaders}})),
    
    on(Actions.CanAccessHeadSetData, (state) => ({ ...state, CanAccessHead: {...state.CanAccessHead, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.CanAccessHeadSetError, (state,{errors}) => ({ ...state, CanAccessHead: {...state.CanAccessHead, isLoaded: false, hasError: true,errors: errors, data: {  } as HttpHeaders  }})),
    // @ts-ignore
    on(Actions.CanAccessHeadSuccess, (state) => ({ ...state, CanAccessHead: {...state.CanAccessHead, data: state?.CanAccessHead?.data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.CanAccessHeadRequestUpdateOneSuccess, (state, {key, value}) => ({ ...state, CanAccessHead: {...state.CanAccessHead, ...state.CanAccessHead ,request: {...state.CanAccessHead.request, [key]:value} }})),
    // @ts-ignore
    on(Actions.CanAccessHeadRequestUpdateSuccess, (state, {request}) => ({ ...state, CanAccessHead: {...state.CanAccessHead, ...state.CanAccessHead ,request: request }})),
    // @ts-ignore
