...
export class CartItemFacade {
  ...
  public get FiltersFirstGet$(): Observable<CartItem> { return this.store.select(selectFiltersFirstGetData); }
  ...
  public get FiltersGet$(): Observable<Pagination<CartItem>> { return this.store.select(selectFiltersGetData); }
  ...
  public get Get$(): Observable<CartItem> { return this.store.select(selectGetData); }
  ...
  public get IdsGet$(): Observable<Pagination<CartItem>> { return this.store.select(selectIdsGetData); }
  ...
  public get Post$(): Observable<CartItem> { return this.store.select(selectPostData); }
  ...
  public get Put$(): Observable<CartItem> { return this.store.select(selectPutData); }
  ...
  public get RangePost$(): Observable<Pagination<CartItem>> { return this.store.select(selectRangePostData); }
  ...
  public get RangePut$(): Observable<Pagination<CartItem>> { return this.store.select(selectRangePutData); }
