...
const initialState = {
    ...
    FiltersGet: {
        ...
        isLoaded: false,
        errors: [],
        data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem> ,
        request: null,
    },
    Get: {
        firstInit: true,
...
const reducer = createReducer<State>(
  initialState,
    ...
    // @ts-ignore
    on(Actions.FiltersFirstGetInit, state => ({...state, FiltersFirstGet:{ ...state.FiltersFirstGet, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  {  } as CartItem  , request: null} })),
    // @ts-ignore
    on(Actions.FiltersFirstGetDataInit, state => ({...state, FiltersFirstGet:{ ...state.FiltersFirstGet, data: {  } as CartItem}})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.FiltersFirstGetSetError, (state,{errors}) => ({ ...state, FiltersFirstGet: {...state.FiltersFirstGet, isLoaded: false, hasError: true,errors: errors, data: {  } as CartItem  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.FiltersGetInit, state => ({...state, FiltersGet:{ ...state.FiltersGet, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  , request: null} })),
    // @ts-ignore
    on(Actions.FiltersGetDataInit, state => ({...state, FiltersGet:{ ...state.FiltersGet, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>}})),
    // @ts-ignore
    on(Actions.FiltersGetSetData, (state, {data}) => ({ ...state, FiltersGet: {...state.FiltersGet, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.FiltersGetSetError, (state,{errors}) => ({ ...state, FiltersGet: {...state.FiltersGet, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.GetInit, state => ({...state, Get:{ ...state.Get, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  {  } as CartItem  , request: null} })),
    // @ts-ignore
    on(Actions.GetDataInit, state => ({...state, Get:{ ...state.Get, data: {  } as CartItem}})),
    // @ts-ignore
    on(Actions.GetSetData, (state, {data}) => ({ ...state, Get: {...state.Get, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.GetSetError, (state,{errors}) => ({ ...state, Get: {...state.Get, isLoaded: false, hasError: true,errors: errors, data: {  } as CartItem  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.IdsGetInit, state => ({...state, IdsGet:{ ...state.IdsGet, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  , request: null} })),
    // @ts-ignore
    on(Actions.IdsGetDataInit, state => ({...state, IdsGet:{ ...state.IdsGet, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>}})),
    // @ts-ignore
    on(Actions.IdsGetSetData, (state, {data}) => ({ ...state, IdsGet: {...state.IdsGet, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.IdsGetSetError, (state,{errors}) => ({ ...state, IdsGet: {...state.IdsGet, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.PostInit, state => ({...state, Post:{ ...state.Post, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  {  } as CartItem  , request: null} })),
    // @ts-ignore
    on(Actions.PostDataInit, state => ({...state, Post:{ ...state.Post, data: {  } as CartItem}})),
    // @ts-ignore
    on(Actions.PostSetData, (state, {data}) => ({ ...state, Post: {...state.Post, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.PostSetError, (state,{errors}) => ({ ...state, Post: {...state.Post, isLoaded: false, hasError: true,errors: errors, data: {  } as CartItem  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.PutInit, state => ({...state, Put:{ ...state.Put, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  {  } as CartItem  , request: null} })),
    // @ts-ignore
    on(Actions.PutDataInit, state => ({...state, Put:{ ...state.Put, data: {  } as CartItem}})),
    // @ts-ignore
    on(Actions.PutSetData, (state, {data}) => ({ ...state, Put: {...state.Put, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.PutSetError, (state,{errors}) => ({ ...state, Put: {...state.Put, isLoaded: false, hasError: true,errors: errors, data: {  } as CartItem  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.RangePostInit, state => ({...state, RangePost:{ ...state.RangePost, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  , request: null} })),
    // @ts-ignore
    on(Actions.RangePostDataInit, state => ({...state, RangePost:{ ...state.RangePost, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>}})),
    // @ts-ignore
    on(Actions.RangePostSetData, (state, {data}) => ({ ...state, RangePost: {...state.RangePost, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.RangePostSetError, (state,{errors}) => ({ ...state, RangePost: {...state.RangePost, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  }})),
    // @ts-ignore
    ...
    // @ts-ignore
    on(Actions.RangePutInit, state => ({...state, RangePut:{ ...state.RangePut, firstInit: false, hasError: false, errors: [],  isLoaded: false, data:  { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  , request: null} })),
    // @ts-ignore
    on(Actions.RangePutDataInit, state => ({...state, RangePut:{ ...state.RangePut, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>}})),
    // @ts-ignore
    on(Actions.RangePutSetData, (state, {data}) => ({ ...state, RangePut: {...state.RangePut, data: data, isLoaded: true, hasError: false, errors: [] }})),
    // @ts-ignore
    on(Actions.RangePutSetError, (state,{errors}) => ({ ...state, RangePut: {...state.RangePut, isLoaded: false, hasError: true,errors: errors, data: { currentPage: 0,totalPages: 0,pageSize: 0,totalCount: 0, items: [] } as Pagination<CartItem>  }})),
    // @ts-ignore
